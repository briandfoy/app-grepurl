...
=head1 The grepurl module

This is the I<README> for the L<grepurl> Perl module. You're probably 
...
To read about L<grepurl>, look at the embedded documentation 
...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/grepurl> or 
L<MetaCPAN|http://www.metacpan.org/module/grepurl>:

=over 4

=item *	L<http://search.cpan.org/dist/grepurl>

=item *	L<http://www.metacpan.org/module/grepurl>
